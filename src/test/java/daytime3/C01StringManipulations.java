...
public class C01StringManipulations {
    ...
    public static void main(String[] args) {
       ...
       //Sonrasinda kullanici nasil girerse girsin konsole da buyuk harfle yazilmasini saglayin
        ...
        String isim = input.nextLine(), soyAd= input.nextLine();//multiple decleration denir
     ...
     //Verilen bir cumleyi yildiz "*" ile gizleyin,10.karakterden sonrsini yazdirin
     ...
     //a harfi yerine @ isareti yerlestiriniz
        ...
        //txt'deki ilk bulunan a'y 'e'ile degistir
       ...
       String str4 = "";
        ...
        // Kullanicidan isim ve soyisim girmeisni isteyin
        // hangisinin
        // daha uzun oldugunu olusturan kodu yazinis
